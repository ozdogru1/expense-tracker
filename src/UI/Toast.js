...
const Toast = (props) => {
  ...
  return (
    <>
      <div
        id="toast-danger"
        class={`flex ${props.error === null  ? "animate-bounce opacity-0":null } items-center p-4 mb-4 w-full max-w-xs text-red-800 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800`}
        role="alert"
      >
